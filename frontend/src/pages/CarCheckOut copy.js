...
function CarCheckOut({ bookingDetails }) {
  ...
  useEffect(() => {
    fetch("http://supremo-api.oracledemo.online/car-service-redis/cars"+`/${id}`)
  ...
  const handleCheckout = async () => {
    ...
    const response = await fetch("http://supremo-api.oracledemo.online/order-service/create-order", {
      method: 'POST',
      headers: {
